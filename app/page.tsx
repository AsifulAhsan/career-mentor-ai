...
import { ArrowRight, GraduationCap, Target, Building2, Heart, Github, Twitter, Linkedin, Mail } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Get a personalized, step-by-step career roadmap tailored to your interests, academic performance, and goals.",
    ...
    },
    {
      ...
      description: "Experience a day in the life of any career. Get insights on salary, job demand, and required skills.",
    ...
    },
    {
      ...
      number: "03",
      title: "Admission Hub",
      description: "Find and compare universities worldwide. Get AI-powered admission suggestions and scholarship opportunities.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section with Fixed Title */}
        <section className="container mx-auto px-4 pt-16 pb-12">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-8 leading-tight">
              Your Future, Intelligently<br />
              <span className="mt-2 bg-gradient-to-r from-orange-600 via-amber-500 to-orange-500 bg-[length:200%_auto] bg-clip-text text-transparent animate-gradient">
                Designed
              </span>
            </h1>
            
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed mb-8">
              Discover your perfect career path with AI-powered guidance, personalized roadmaps, and real-world insights.
            </p>
          </div>
        </section>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="h-full p-8 flex flex-col justify-between relative z-10">
                        ...
                        `}>
                          <span className={`
                            ...
                            ${isActive ? 'border-white/50' : 'border-transparent group-hover:border-orange-300'}
                          `}>
                            {feature.action}
                          </span>
                      ...
                      <div className={`
                        absolute inset-0 rounded-2xl bg-gradient-to-r ${feature.gradient} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-slate-600 max-w-md text-sm leading-relaxed">
                  Empowering students worldwide with intelligent career planning, personalized roadmaps, 
                  and AI-driven insights to build successful futures.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <a href="/roadmap" className="text-slate-600 hover:text-orange-500 transition-colors">
                      Career Roadmap
                    </a>
                  </li>
                  <li>
                    <a href="/simulator" className="text-slate-600 hover:text-orange-500 transition-colors">
                      Career Simulator
                    </a>
                  </li>
                  <li>
                    <a href="/admissions" className="text-slate-600 hover:text-orange-500 transition-colors">
                      Admission Hub
                    </a>
                  </li>
                </ul>
            ...
            <div className="pt-8 border-t border-orange-100">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-sm text-slate-600 flex items-center gap-1">
                  © 2025 CareerMentor AI. Made with <Heart className="w-4 h-4 text-red-500 fill-current" /> for students
                </p>
